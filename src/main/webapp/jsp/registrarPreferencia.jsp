              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <label class="form-label" for="txtEdadMinima">Edad mínima</label>	    
                    <input type="number" class="form-control" name="txtEdadMinima" id="txtEdadMinima" placeholder="${mascota.preferencia.edadMinima}" min="1" pattern="^[0-9]+" /> <br>
                    <label class="form-label" for=txtEdadMaxima>Edad máxima</label>	 
                    <input type="number" class="form-control" name="txtEdadMaxima" id="txtEdadMaxima" placeholder="${mascota.preferencia.edadMaxima}" min="1" pattern="^[0-9]+" /> <br> 
                  </div>
